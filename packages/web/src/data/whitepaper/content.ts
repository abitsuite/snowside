  ...
  sections: [
    {
      ...
      body: [
        ...
        '\u2022 Sub-second finality through Avalanche Snowball consensus',
        ...
        '\u2022 Permissionless validation roadmap — phased transition from permissioned launch to BTC-only bonding with AVAX phase-out',
    ...
    },
    {
      ...
      body: [
        'Snowside is an EVM-compatible Layer-1 blockchain running on Avalanche\'s consensus infrastructure. It combines three layers: an EVM execution environment, Avalanche\'s Snowball consensus protocol for fast finality, and Blind Merged Mining for Bitcoin-anchored settlement security.',
        '## EVM Execution Layer',
        ...
        '\u2022 Phased permissionless participation — permissioned at launch, open with BTC bonding in Phase 2, BTC-only in Phase 3',
    ...
    },
    {
      ...
      body: [
        ...
        '## How BMM Works',
        'Validators produce and finalize Snowside blocks. Settlement proposers then submit compact block header commitments for these finalized blocks to the Bitcoin mainchain. Bitcoin miners include these commitments in their coinbase transactions. The miner who includes a commitment earns a BTC fee from the settlement proposer who submitted it.',
        ...
        'Validators:',
        '\u2022 Run Snowball consensus and produce new Snowside blocks',
        ...
        '\u2022 Settlement proposers pay a portion of Base Fees as BMM incentives to Bitcoin miners',
    ...
    },
    {
      ...
      body: [
        'Snowside\'s consensus and security model combines two layers: Avalanche\'s Snowball consensus for fast, deterministic finality, and Blind Merged Mining for Bitcoin-anchored settlement. Together, they provide a three-tier confirmation model that lets users choose the trust level appropriate to their use case.',
        '## Layer 1: Avalanche Snowball Consensus',
        'Snowside validators run Avalanche\'s Snowball consensus protocol. Snowball is the linear-chain variant of the Avalanche Consensus Protocol, designed for blockchains that require a total ordering of transactions. Key properties:',
    ...
    },
    {
      ...
      body: [
        ...
        'Validator participation follows a three-phase roadmap (detailed in section 12):',
        ...
        '\u2022 Phase 3 (Bitcoin-Native): BTC-only bonding, AVAX dependency eliminated',
        ...
        'When Snowball consensus detects validator misbehavior, the bonded BTC is burned in L2 state. This prevents the validator from ever withdrawing that BTC back to eCash L1 via the peg-out mechanism.',
        'Slashing conditions:',
        ...
        'Enforcement:',
        '\u2022 Snowball consensus detects misbehavior',
        ...
        '\u2022 Consensus participation: Must participate in at least 90% of Snowball consensus votes over rolling 7-day window',
    ...
    },
    {
      ...
      body: [
        ...
        'Snowside\'s path to permissionless validation follows a three-phase roadmap that transitions from a permissioned launch to fully Bitcoin-native sybil resistance with AVAX dependency eliminated.',
        ...
        'Phase 3 — Bitcoin-Native Sybil Resistance (AVAX Phase-Out):',
        '\u2022 Reduce and eventually eliminate AVAX staking dependency',
        '\u2022 Transition to BTC-only bonding via BMM peg (no wrapped tokens, no AVAX, pure Bitcoin alignment)',
        '\u2022 Custom precompile for bond management, slashing signals, and validator registry',
        '\u2022 Dynamic bond requirements based on network usage and total value secured',
        '\u2022 Explore alternative Primary Network participation mechanisms or fully sovereign validation independent of AVAX',
        '\u2022 This phase is the long-term goal: Snowside validation should be accessible to anyone who holds BTC, with no secondary token requirements',
        '\u2022 Target: fully Bitcoin-aligned permissionless validation',
        'The Phase 3 AVAX phase-out is a critical long-term objective. While AVAX staking is a pragmatic requirement for Avalanche Primary Network participation in Phases 1-2, it creates a dependency on a secondary token that conflicts with Snowside\'s Bitcoin-native philosophy. The Phase 3 transition is a core roadmap commitment, not merely an exploration.',
      ],
    },
    {
      heading: 'Conclusion',
