  ...
  sections: [
    {
      heading: 'Tl;dr',
      body: [
        'Snowside is a dedicated Avalanche Layer-1 blockchain built to host Paul Sztorc\'s upcoming eCash hard-fork. It runs as a clean EVM sidechain where the native gas token is ECX itself — no new minted tokens, no pre-mine, just Bitcoin security via blind merged mining.',
        'Key properties:',
        '\u2022 Native ECX gas — transaction fees paid in ECX, no new token, no pre-mine',
        '\u2022 Bitcoin security via Blind Merged Mining (BIP-301) on eCash',
        ...
        '\u2022 Contract Fees may be denominated in ECX or USDC at the contract owner\'s discretion',
        '\u2022 Treasury distributes to the Snowside Foundation (10% retained), Settlement Proposers (5%), and Validators (85%, proportional to bonded ECX)',
        ...
        '\u2022 Permissionless validation roadmap — phased transition from permissioned launch to permissionless AVAX + ECX bonding',
    ...
    },
    {
      ...
      body: [
        ...
        '\u2022 Phased permissionless participation — permissioned at launch, open with AVAX + ECX bonding in Phase 2',
    ...
    },
    {
      ...
      body: [
        ...
        '## How BMM Works',
        'Validators produce and finalize Snowside blocks. Settlement proposers then submit compact block header commitments for these finalized blocks to the eCash mainchain. eCash miners include these commitments in their coinbase transactions. The miner who includes a commitment earns an ECX fee from the settlement proposer who submitted it.',
        ...
        '\u2022 Require ECX bonding (Phase 2+) for sybil resistance',
        ...
        '\u2022 Sybil resistance is economic: each BMM commitment costs real ECX (paid to miners)',
        ...
        '\u2022 M5 (Deposit): Move ECX from eCash L1 to Snowside L2',
        '\u2022 M6 (Withdraw): Move ECX from Snowside L2 to eCash L1 (canonical, slow path — approximately 3-6 months)',
        '\u2022 M3/M4 (Withdrawal bundle processes): Part of the canonical withdrawal flow',
        '## Economic Incentives',
        'The economic model is simple and self-sustaining:',
        '\u2022 Snowside users pay ECX for gas (Base Fees and Priority Fees). Contract Fees may be denominated in ECX or USDC at the contract owner\u2019s discretion.',
        '\u2022 Validators collect Priority Fees and Treasury distribution (85% of net, proportional to bonded ECX)',
...
'## Settlement Finality',
    ...
    {
      heading: 'ECX as Native Gas',
      body: [
        'All transaction fees on Snowside are paid in ECX. There is no alternative gas token, no new minted token, and no pre-mine. The only assets on Snowside are ECX (for gas) and USDC (bridged from C-Chain via ICM).',
        '## Why ECX Gas Matters',
        'Using ECX as the native gas token preserves Bitcoin\'s economic model. Users are not forced to acquire a new, speculative token to interact with the chain. They use ECX — eCash\'s native cryptocurrency, secured by Bitcoin-class proof-of-work — for all transactions.',
        ...
        '\u2022 Blind Merged Mining: ECX flows between eCash and Snowside via the BMM peg mechanism',
        '\u2022 Bridges: Users can bridge value from other chains to obtain ECX on Snowside',
        gasFlow,
        '## Three-Part Fee Model',
        'Snowside adopts a three-part fee structure, denominated in ECX, that separates settlement security costs from validator incentives and contract developer revenue.',
        feeModel,
        ...
        '',
        'Validators (85% of gross): The remainder of the Treasury\u2019s total capture, distributed 100% proportional to bonded ECX. This eliminates the sybil incentive that would exist under an equal-distribution component \u2014 validators cannot game the distribution by splitting into multiple small validators. Only bonded ECX matters.',
        '',
        ...
        'Because ECX is the only gas token, Bitcoin\'s economic incentives flow directly into Snowside. eCash miners who secure Snowside via BMM are paid in ECX. Users who transact on Snowside pay in ECX. The economic loop is predominantly Bitcoin-native — no competing incentive structures, no token dilution, no governance games.',
        ...
        'For all other USDC recipients \u2014 Contract Owners, Validators, and Settlement Proposers \u2014 the auto-bridge to C-Chain is the default configuration but is configurable on a per-recipient basis:',
        '\u2022 Contract Owners may configure the auto-bridge setting during contract deployment or at any time thereafter. This configuration can be changed at any time by the Contract Owner. A batch transfer mode is also available as a configuration option, allowing owners to accumulate USDC on Snowside and bridge at intervals rather than per-settlement.',
        '\u2022 Validators may configure their auto-bridge preference when joining the network or at any time thereafter. If auto-bridge is enabled (default), the Validator\u2019s USDC distribution is bridged to C-Chain and delivered as USDC on C-Chain, proportional to bonded ECX. If auto-bridge is disabled, the Validator\u2019s USDC distribution remains on Snowside.',
        '\u2022 Settlement Proposers may configure their auto-bridge preference as part of the settlement process or at any time. If auto-bridge is enabled (default) and the proposer designates a C-Chain address, the proposer\u2019s USDC portion is bridged to C-Chain. If auto-bridge is disabled or no C-Chain address is designated, the USDC remains on Snowside at the proposer\u2019s discretion.',
        'For ECX-denominated Contract Fees, all captured value remains on Snowside within the ECX economy. The Foundation\u2019s retained ECX, the Validators\u2019 ECX distribution, and the Settlement Proposers\u2019 ECX share all remain on Snowside.',
        ...
        'The Foundation manages the Treasury directly. For USDC-denominated Contract Fees, the Treasury\u2019s USDC share remains on Snowside under Foundation management. For ECX-denominated Contract Fees, the Treasury\u2019s ECX share is managed by the Foundation on Snowside.',
        'The remaining 90% of the Treasury\u2019s gross capture is distributed to Settlement Proposers (5% at default configuration, configurable by validator governance) and Validators (85% at default configuration, distributed 100% proportional to bonded ECX).',
        'Note on governance: The specific governance mechanism for adjusting the Settlement Proposer and Validator distribution percentages is not yet finalized. Snowside Validators will have the ability to adjust these parameters through a governance process to be defined in a future protocol upgrade.',
        ...
        '',
        'Value Capture: Snowside captures value through three fee streams \u2014 Base Fees (ECX, directed to eCash miners), Priority Fees (ECX, to validators), and Contract Fees (ECX or USDC, split between contract owners and the Treasury). The Treasury\u2019s 10% retained portion funds ecosystem development, operational costs, and the fallback settlement proposer.',
        '',
        'Value Distribution: The Treasury distributes to Settlement Proposers (5%) and Validators (85%, proportional to bonded ECX). Contract Owners receive their vested share (50% -> 80% over 18 months). For USDC-denominated Contract Fees, the Contract Owner\u2019s share auto-bridges to C-Chain by default, generating value flow back into the Avalanche ecosystem.',
        '',
        ...
        '\u2022 Capture: The Treasury captures Contract Fees from opted-in contracts (ECX or USDC)',
    ...
    },
    {
      ...
      body: [
        ...
        'In Phase 2 and beyond, validators bond ECX via the BMM peg mechanism for sybil resistance. The minimum bond is 0.3 ECX (approximately $20,000), modeled after Avalanche\'s original 2,000 AVAX requirement. Bonded ECX is locked on eCash L1 through the peg-in process and tracked in Snowside L2 state — no wrapped tokens, no custodians. Misbehavior triggers slashing: bonded ECX is burned in L2 state, making it permanently unrecoverable. Detailed bonding requirements, slashing conditions, and performance standards are described in section 9 (Validator Economics).',
    ...
    },
    {
      ...
      body: [
        ...
        'Snowside validators participate in Avalanche\'s Primary Network by staking AVAX. The Avalanche9000 upgrade introduced a subscription model that dramatically reduces the cost of running an L1 validator. Operational costs are approximately $10-20 per month per validator — negligible compared to the revenue from ECX gas fees.',
        '## Revenue: Priority Fees and Contract Fees',
        'Validators earn revenue from two sources: Priority Fees (100% to the block-producing validator, paid in ECX) and the Treasury\u2019s distribution of captured Contract Fees (85% of Treasury gross capture at default configuration, distributed 100% proportional to bonded ECX). Contract Fee distribution to validators may be denominated in ECX or USDC depending on the originating contract\u2019s denomination. USDC-denominated validator distributions are auto-bridged to C-Chain via ICM (see Section 5.7). See section 5 for the full three-part fee model details.',
        ...
        '\u2022 Phase 2 (Permissionless): Open registration with AVAX + 0.3 ECX bond via BMM peg, slashing active',
        'The requirements for Phase 2+ are:',
        '\u2022 A server (VPS) with basic specifications',
        '\u2022 AVAX for the Avalanche Primary Network stake (Phase 1-2)',
        '\u2022 0.3 ECX minimum bond via BMM peg (Phase 2+)',
        ...
        validatorEconomics,
        '## ECX Bonding Requirements',
        'Minimum bond: 0.3 ECX (approximately $20,000 at current ECX prices).',
        'Rationale: Avalanche\'s original validator requirement was 2,000 AVAX. At approximately $10/AVAX, this equated to ~$20,000 — a threshold that proved accessible enough to attract broad participation while remaining costly enough to deter casual sybils. Snowside adopts the same dollar-equivalent threshold in ECX terms.',
        'Bond mechanism: ECX is bonded via the BMM peg (drivechain mechanism). Validators lock ECX on the eCash L1 through the peg-in process, and the bonded amount is tracked in Snowside L2 state. No wrapped tokens, no custodians — pure Bitcoin alignment.',
        ...
        '\u2022 ECX/USD exchange rate (significant price appreciation -> lower ECX amount to maintain dollar-equivalent threshold)',
        '## Slashing via BMM Peg',
        'When Snowman consensus detects validator misbehavior, the bonded ECX is burned in L2 state. This prevents the validator from ever withdrawing that ECX back to eCash L1 via the peg-out mechanism.',
        'Slashing conditions:',
        '\u2022 Double-signing: Full bond slash (100% of bonded ECX)',
        '\u2022 Invalid block proposal: Full bond slash',
        '\u2022 Extended downtime (>10% of blocks missed over 30 days): Partial slash (25% of bonded ECX) + removal from active set',
        ...
        '\u2022 Bonded ECX amount is burned in L2 state',
        '\u2022 The actual ECX remains locked on eCash L1 but becomes permanently unrecoverable — the L2 will never generate a valid withdrawal transaction for the slashed amount',
        'Economic outcome: The validator permanently loses access to their bonded ECX. The ECX is not destroyed on L1 (it remains locked in the peg script), but it is economically burned — no one can ever access it. This is real, enforceable slashing without requiring wrapped tokens or smart contract custody.',
        '## Validator Performance Requirements',
        'To ensure network reliability and give prospective validators clear expectations before bonding ECX, Snowside establishes minimum performance standards. These are separate from slashing conditions — underperformance results in warnings and eventual removal, not bond confiscation.',
    ...
    },
    {
      ...
      body: [
        ...
        'Ethereum L2s and rollups offer EVM compatibility but require wrapping BTC to use it as gas. They share a sequencer with other L2s, have multi-minute confirmation times, and offer no custom precompiles. Snowside provides native ECX gas, sovereign validators, sub-2-second finality, and custom precompiles.',
        '## vs Avalanche C-Chain',
        'The C-Chain uses AVAX for gas and shares validators with all C-Chain users. Snowside has its own validator set, uses ECX for gas, and can implement custom precompiles for eCash-specific logic. This sovereignty is essential for a Bitcoin-aligned sidechain.',
        '## vs Standalone Chain',
        'A standalone chain could theoretically implement ECX gas and custom precompiles, but it would lack Avalanche\'s ICM bridge for USDC, require expensive manual validator operations, and miss the operational automation provided by NodΞRunr. Snowside inherits all of Avalanche\'s infrastructure benefits while maintaining Bitcoin alignment.',
      ],
    },
    {
      ...
      body: [
        ...
        '## ECX bridge or custody risk',
        'Mitigation: Use established, audited bridge infrastructure. Avalanche ICM for USDC is trust-minimized with no third-party custodian. BMM design for ECX avoids centralized custody entirely.',
    ...
    },
    {
      ...
      body: [
        ...
        'Snowside\'s path to permissionless validation follows a two-phase roadmap that transitions from a permissioned launch to permissionless AVAX + ECX bonding.',
        ...
        'Phase 2 — Permissionless with AVAX + ECX Bonding:',
        '\u2022 Open validator registration to anyone meeting requirements',
        '\u2022 Requirements: AVAX stake for Primary Network + ECX bond via BMM peg (minimum 0.3 ECX, approximately $20,000)',
        '\u2022 Slashing active for misbehavior',
        '\u2022 Contract Fee distribution: 100% proportional to bonded ECX (via Treasury distribution \u2014 see Section 5.5)',
        '\u2022 Bond amount is governance-adjustable based on total value secured, number of active validators, and ECX/USD exchange rate',
